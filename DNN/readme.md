...
之所以使用 convolution 的原因是因為資料為一個 1 dimension 3 channel 的時序訊號 ( window size 沿用原始設置 32 )，而 1d convolution 可以拿來做訊號的處理，所以我們想用 1D convolution layers 來取代 Linear layers 當作我們的 Feature Extraction operator。
